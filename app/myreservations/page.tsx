                ...
                <div className='space-y-4'>
                    <div className='p-5  grid grids-cols-1 md:grid-cols-4 gap-4 shadow-md border border-gray-300 rounded-xl'>
                        ...
                        <div className='col-span-1 md:col-span-3 '>
                            ...
                            <p className='mb-2'><strong>Number of night:</strong> 2</p>
                            <p className='mb-2'><strong>Total price:</strong> $200</p>

                            <div className='mt-6 inline-block cursor-pointer py-6 px-6 bg-airbnb text-white rounded-xl'>Go to propertie</div>
                        </div>
                    </div>
